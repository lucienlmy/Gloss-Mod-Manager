...
//                 this.task.status = DownloadStatus.DOWNLOADING
//                 response.on('data', chunk => {

//                     if (this.task.status == DownloadStatus.PAUSED) return
...
//                         // 下载完毕
//                         this.task.status = DownloadStatus.COMPLETED
...
//      */
//     public pause() {
//         this.task.status = DownloadStatus.PAUSED
//         this.request?.end()
//         this.fileStream?.close()
//         this.fileStream = undefined
//         console.log(`pause:${this.task.status}`);
