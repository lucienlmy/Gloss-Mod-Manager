...
import DownloadBtn from '@src/components/Explore/CurseForge/DownloadBtn.vue'
    ...
    <v-row v-if="curseforge.modData">
        <v-col cols="12">
            <el-descriptions size="large" :column="1" border>
                ...
                <el-descriptions-item
                    :label="$t('Release time')">{{ new Date(curseforge.modData.dateReleased).toLocaleString() }}</el-descriptions-item>
                <el-descriptions-item
                    :label="$t('Update time')">{{ new Date(curseforge.modData.dateModified).toLocaleString() }}</el-descriptions-item>
                <el-descriptions-item
                    :label="$t('Download count')">{{ curseforge.modData.downloadCount }}</el-descriptions-item>
            </el-descriptions>
        </v-col>
