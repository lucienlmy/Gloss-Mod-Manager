...
import Filter from '@src/components/Explore/ModIo/Filter.vue'
import ModList from '@src/components/Explore/ModIo/ModList.vue'
import TurnPage from "@src/components/Explore/ModIo/TurnPage.vue";
...
<template>
    <Search>
        <v-text-field v-model="modio.filter.searchText" class="search-input"
            :placeholder="$t('You can search for what you want here')" variant="underlined" append-inner-icon="mdi-magnify"
            @keydown.enter="modio.search" @click:append-inner="modio.search">
        </v-text-field>
    </Search>
    <Filter></Filter>
