...
import ModIoDownloadBtn from "@src/components/Explore/ModIo/DownloadBtn.vue"
        ...
        <v-col cols="12">
            <el-descriptions size="large" :column="1" border>
                <el-descriptions-item min-width="100"
                    :label="$t('Author')">{{ modio.selected.data?.submitted_by.username }}</el-descriptions-item>
                <el-descriptions-item :label="$t('Update time')">{{ time }}</el-descriptions-item>
                <el-descriptions-item
                    :label="$t('Download count')">{{ modio.selected.data?.stats.downloads_total }}</el-descriptions-item>
                <el-descriptions-item
                    :label="$t('Mark count')">{{ modio.selected.data?.stats.ratings_positive }}</el-descriptions-item>
                <el-descriptions-item
                    :label="$t('Subscribers')">{{ modio.selected.data?.stats.subscribers_total }}</el-descriptions-item>
