...
import SortModList from "@src/components/Manager/SortMod/ModList.vue"
...
<template>
    ...
    <Teleport to="body">
        <el-dialog v-model="sortMod.dialogVisible" title="排序管理" width="70%" :draggable="true" :close-on-click-modal="false">
