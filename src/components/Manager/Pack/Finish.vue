...
<template>
    ...
    <el-result v-else-if="type == 'inport'" icon="success" :title="$t('Finish')"
        :sub-title="$t('Import completed, you can now enable these mods in the manager and enter the game...')">
    </el-result>
</template>
<script lang='ts'>
