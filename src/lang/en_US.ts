...
const DownloadTasks = {
    ...
    // "Waiting": "Waiting",
    Unknown: "Unknown",
    "No download tasks available at the moment.":
        "No download tasks available at the moment.",
...
const ExploreFilter = {
    ...
    Sort: "Sort",
    Search: "Search Works",
    "You can search for what you want here":
        "You can search for what you want here",
    "Game Type": "Game Type",
    "3DM Mods": "3DM Mods",
...
const ManagerContent = {
    ...
    Update: "Update",
    Delete: "Delete",
    "You have not selected a game yet. Please select a game first":
        "You have not selected a game yet. Please select a game first.",
    Partner: "Partner",
    Name: "Name",
    Version: "Version",
    ...
    Preview: "Preview",
    Action: "Action",
    "Drag and drop the Mod compressed package here for management":
        "Drag and drop the Mod compressed package here for management",
    ...
    "Are you sure you want to delete this Mod?":
        "Are you sure you want to delete this Mod?",
    "This mod was not downloaded from the manager and cannot be updated":
        "This mod was not downloaded from the manager and cannot be updated",
    Pack: "Pack",
    Weight: "Weight",
    Desc: "Desc",
...
const ManagerHeader = {
    ...
    Logs: "Logs",
    "Your GMM package has been exported, you can...":
        "Your GMM package has been exported, you can...",
...
const Settings = {
    ...
    Language: "Language",
    Select: "Select",
    "Auto install for download":
        "Automatically add to the Manager after downloaded",
    ...
    Auto: "Auto",
    "Mod Folder Tip":
        "You can set it to any directory, but don't set it to the game directory to avoid unknown errors",
...
const Backup = {
    ...
    "Please select at least one saves to back up":
        "Please select at least one saves to back up",
