...
export const supportedGames = async () => ({
    ...
    installdir: await join("GTA San Andreas - Definitive Edition", "Gameface", "Binaries", "Win64"),
    ...
    startExe: [
        ...
        {
            name: "直接启动",
            exePath: await join("Gameface", "Binaries", "Win64", "SanAndreas.exe")
        }
    ],
    archivePath: await join(await FileHandler.getMyDocuments(), "Rockstar Games", "GTA San Andreas Definitive Edition"),
