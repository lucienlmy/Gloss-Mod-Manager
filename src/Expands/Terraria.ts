...
export const supportedGames = async () => ({
    ...
    archivePath: await join(await FileHandler.getMyDocuments(), "My Games", "Terraria"),
    gameCoverImg: "https://assets-mod.3dmgame.com/static/upload/game/64cc631c336ce.webp",
    modType: [
        {
            id: 1,
            name: "pack",
            installPath: await join(await FileHandler.getMyDocuments(), "My Games", "Terraria", "ResourcePacks"),
            async install(mod) {
                void mod;
        ...
        },
        {
            id: 2,
            name: "tmod",
            installPath: await join(await FileHandler.getMyDocuments(), "My Games", "Terraria", "tModLoader", "Mods"),
            async install(mod) {
                void mod;
