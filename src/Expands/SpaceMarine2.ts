...
export const supportedGames = async () => ({
    ...
    archivePath: await join(await FileHandler.GetAppData(), "Local", "Saber", "Space Marine 2"),
    gameCoverImg: "https://assets-mod.3dmgame.com/static/upload/mod/202410/MOD6707728ca7d89.webp@webp",
    modType: [
        {
            id: 1,
            name: "pak",
            installPath: await join("client_pc", "root", "paks", "client", "default"),
            async install(mod) {
                void mod;
