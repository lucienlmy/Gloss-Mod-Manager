...
export const supportedGames = async () => ({
    ...
    archivePath: await join(await ScanGame.getSteamInstallPath() || "", "userdata", await ScanGame.GetLastSteamId32(), "632360", "remote"),
    gameCoverImg: "https://assets-mod.3dmgame.com/static/upload/game/64ad1276b1fca.png",
    modType: [
        {
            id: 2,
            name: "REFramework",
