...
export const supportedGames = async () => ({
    ...
    archivePath: await join(await FileHandler.getMyDocuments(), "Paradox Interactive", "Stellaris"),
    gameCoverImg: "https://assets-mod.3dmgame.com/static/upload/game/21.jpg",
    modType: [
        {
            id: 1,
            name: "Mods",
            installPath: await join(await FileHandler.getMyDocuments(), "Paradox Interactive", "Stellaris", "mod"),
            async install(mod) {
                void mod;
