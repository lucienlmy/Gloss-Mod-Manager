...
export async function executeSidecar(
    ...
    return Sidecar.execute(commandName, args, options);
}
...
export async function spawnSidecar(
    ...
    return Sidecar.spawn(commandName, args, options);
}

export async function executeSevenZipSidecar(
    args: readonly string[],
    options: SidecarCommandOptions = {},
) {
...
export async function executeAria2Sidecar(
    args: readonly string[],
    options: SidecarCommandOptions = {},
) {
...
export async function spawnAria2Sidecar(
    args: readonly string[],
    options: SidecarCommandOptions = {},
) {
    return Sidecar.spawnAria2(args, options);
}
