...
import ExploreContentHeader from "@src/components/Explore/GlossMod/Content/Header.vue";
import Markdown from '@src/components/Model/Markdown.vue'

const content = useContent()
const route = useRoute()

if (parseInt(route.params.modId as string) != content.modData?.id) {
    content.getModDataByID(parseInt(route.params.modId as string));
}
