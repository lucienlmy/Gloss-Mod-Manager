                ...
                items: [
                    ...
                    { text: "翻译软件 | Translate GMM", link: "/Translate.md" },
                    {
                        ...
                        items: [
                            ...
                            {
                                text: "启动游戏没反应或报错",
                                link: "/FQA/NotStart.md",
                            },
                            {
                                text: "Mod类型未知",
                                link: "/FQA/TypeUnknown.md",
                            },
                            { text: "下载错误", link: "/FQA/DownloadError.md" },
                            {
                                text: "迁移储存位置",
                                link: "/FQA/MoveFolder.md",
                            },
                        ],
                    },
                    {
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            {
                                text: "JSON适配 (1.36.0版本",
                                link: "/Expands/JSON.md",
                            },
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            {
                                text: "赛博朋克2077",
                                link: "/Use/Cyberpunk2077.md",
                            },
                            { text: "生化危机", link: "/Use/RERemake.md" },
                            {
                                text: "怪物猎人世界",
                                link: "/Use/MonsterHunterWorld.md",
                            },
                            {
                                text: "怪物猎人崛起",
                                link: "/Use/MonsterHunterRise.md",
                            },
